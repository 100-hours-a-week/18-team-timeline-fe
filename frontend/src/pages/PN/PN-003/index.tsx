      ...
      <div className="flex-grow overflow-y-auto">
        <div className="container mx-auto px-0 pb-6">
          ...
          <div className="px-4">
            ...
            {newsData.image && (
              <div className="relative mt-4 mb-6 rounded-lg overflow-hidden">
                <div className="aspect-w-16 aspect-h-9 w-full">
                  <img src={newsData.image} alt={newsData.title} className="w-full h-full object-cover rounded-lg" />
                </div>
                <div className="absolute bottom-2 right-2 text-xs bg-black bg-opacity-50 text-white px-2 py-1 rounded max-w-[70%] overflow-hidden whitespace-nowrap text-ellipsis">
                  <a href={newsData.image} target="_blank" rel="noopener noreferrer" className="hover:underline">
            ...
            {/* 타임라인 업데이트 버튼 */}
            <div className="flex justify-center pb-4" style={{ boxShadow: '0 10px 8px -6px rgba(0, 0, 0, 0.1)' }}>
              <button
            ...
            <div className="rounded-xl">
              <TimelineContainer timeline={formattedTimeline} showSources={showSources} toggleSources={toggleSources} />
            </div>
          </div>
        </div>
        ...
        <div
          ...
          ref={commentListRef}
        >
          <SentimentAnalysis title={newsData.title} statistics={newsData.statistics} />
